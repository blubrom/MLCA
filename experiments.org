...
print_gwp_and_energy(output)
    ...
    #+RESULTS:
    : estimated impacts: {'gwp': {'embodied': 2.0, 'direct': 1.43, 'total': 3.0, 'unit': 'kgCO2eq'}, 'pe': {'embodied': 30.0, 'direct': 316.0, 'total': 300.0, 'unit': 'MJ'}, 'adp': {'embodied': 0.0004, 'direct': 1.36e-06, 'total': 0.0004, 'unit': 'kgSbeq'}, 'energy consumption': {'value': 28.0, 'unit': 'kWh'}}
    : to put impacts in perspective: {'relative_SNBC': {'value': 0.002, 'unit': 'Emissions of X Person per year in the "Stratégie Nationale Bas Carbone (SNBC)" sustanability objectives for France'}, 'relative_PB_Climate_Change': {'value': 0.003, 'unit': 'person in a scenario where the Planetary Boundary for Climate Change is not exceded'}, 'relative_PB_ADP': {'value': 0.01, 'unit': 'person in a scenario where the Planetary Boundary for Abiotic Ressources Deplition is not exceded'}}
    : energy consumption: {'value': 28.0, 'unit': 'kWh'}
    : dynamic impacts gwp: {'embodied': 2.0, 'direct': 1.43, 'total': 3.0, 'unit': 'kgCO2eq'}
...
from using measurement tools, the estimated consumption is bigger than
...
ELMo
estimated impacts: {'gwp': {'embodied': 5.0, 'direct': 127.0, 'total': 100.0, 'unit': 'kgCO2eq'}, 'pe': {'embodied': 70.0, 'direct': 3330.0, 'total': 3000.0, 'unit': 'MJ'}, 'adp': {'embodied': 0.001, 'direct': 2.89e-05, 'total': 0.001, 'unit': 'kgSbeq'}, 'energy consumption': {'value': 293.0, 'unit': 'kWh'}}
to put impacts in perspective: {'relative_SNBC': {'value': 0.07, 'unit': 'Emissions of X Person per year in the "Stratégie Nationale Bas Carbone (SNBC)" sustanability objectives for France'}, 'relative_PB_Climate_Change': {'value': 0.1, 'unit': 'person in a scenario where the Planetary Boundary for Climate Change is not exceded'}, 'relative_PB_ADP': {'value': 0.05, 'unit': 'person in a scenario where the Planetary Boundary for Abiotic Ressources Deplition is not exceded'}}
energy consumption: {'value': 293.0, 'unit': 'kWh'}
dynamic impacts gwp: {'embodied': 5.0, 'direct': 127.0, 'total': 100.0, 'unit': 'kgCO2eq'}
direct gwp: 279.99 lbs
...
ELMo
estimated impacts: {'gwp': {'embodied': 5.0, 'direct': 212.0, 'total': 200.0, 'unit': 'kgCO2eq'}, 'pe': {'embodied': 70.0, 'direct': 6520.0, 'total': 7000.0, 'unit': 'MJ'}, 'adp': {'embodied': 0.001, 'direct': 5.66e-05, 'total': 0.001, 'unit': 'kgSbeq'}, 'energy consumption': {'value': 574.0, 'unit': 'kWh'}}
to put impacts in perspective: {'relative_SNBC': {'value': 0.1, 'unit': 'Emissions of X Person per year in the "Stratégie Nationale Bas Carbone (SNBC)" sustanability objectives for France'}, 'relative_PB_Climate_Change': {'value': 0.2, 'unit': 'person in a scenario where the Planetary Boundary for Climate Change is not exceded'}, 'relative_PB_ADP': {'value': 0.05, 'unit': 'person in a scenario where the Planetary Boundary for Abiotic Ressources Deplition is not exceded'}}
energy consumption: {'value': 574.0, 'unit': 'kWh'}
dynamic impacts gwp: {'embodied': 5.0, 'direct': 212.0, 'total': 200.0, 'unit': 'kgCO2eq'}
direct gwp: 467.38 lbs
#+end_example

We obtain the folowing results, the differences can be explained by
...
| NAS             |          656347 |                 871000 |               1710000 |                | 626155 |                377000 | 831143 |               632000 | 1393322.63 |
| ELMo            |             275 |                    293 |                   574 |                |    262 |                   127 | 279.99 |                  212 |     467.38 |
