...
#+RESULTS:
: estimated impacts: {'gwp': {'embodied': 1.7, 'direct': 36.0, 'total': 38.0, 'unit': 'kgCO2eq'}, 'pe': {'embodied': 23.0, 'direct': 1110.0, 'total': 1100.0, 'unit': 'MJ'}, 'adp': {'embodied': 0.00039, 'direct': 9.6e-06, 'total': 0.0004, 'unit': 'kgSbeq'}, 'energy consumption': {'value': 97.3, 'unit': 'kWh'}}
: to put impacts in perspective: {'relative_SNBC': {'value': 0.019, 'unit': 'Emissions of X Person per year in the "Stratégie Nationale Bas Carbone (SNBC)" sustanability objectives for France'}, 'relative_PB_Climate_Change': {'value': 0.038, 'unit': 'person in a scenario where the Planetary Boundary for Climate Change is not exceded'}, 'relative_PB_ADP': {'value': 0.013, 'unit': 'person in a scenario where the Planetary Boundary for Abiotic Ressources Deplition is not exceded'}}
: Direct energy consumption: 97.3 kWh, translates to a cost of 11.676000 $
: estimated impacts: {'gwp': {'embodied': 41.0, 'direct': 864.0, 'total': 910.0, 'unit': 'kgCO2eq'}, 'pe': {'embodied': 560.0, 'direct': 26500.0, 'total': 27000.0, 'unit': 'MJ'}, 'adp': {'embodied': 0.0093, 'direct': 0.00023, 'total': 0.0095, 'unit': 'kgSbeq'}, 'energy consumption': {'value': 2340.0, 'unit': 'kWh'}}
: to put impacts in perspective: {'relative_SNBC': {'value': 0.45, 'unit': 'Emissions of X Person per year in the "Stratégie Nationale Bas Carbone (SNBC)" sustanability objectives for France'}, 'relative_PB_Climate_Change': {'value': 0.92, 'unit': 'person in a scenario where the Planetary Boundary for Climate Change is not exceded'}, 'relative_PB_ADP': {'value': 0.3, 'unit': 'person in a scenario where the Planetary Boundary for Abiotic Ressources Deplition is not exceded'}}
: Direct energy consumption: 2340.0 kWh, translates to a cost of 280.800000 $
: estimated impacts: {'gwp': {'embodied': 3400.0, 'direct': 72000.0, 'total': 75000.0, 'unit': 'kgCO2eq'}, 'pe': {'embodied': 46000.0, 'direct': 2210000.0, 'total': 2300000.0, 'unit': 'MJ'}, 'adp': {'embodied': 0.78, 'direct': 0.0192, 'total': 0.79, 'unit': 'kgSbeq'}, 'energy consumption': {'value': 195000.0, 'unit': 'kWh'}}
: to put impacts in perspective: {'relative_SNBC': {'value': 38.0, 'unit': 'Emissions of X Person per year in the "Stratégie Nationale Bas Carbone (SNBC)" sustanability objectives for France'}, 'relative_PB_Climate_Change': {'value': 77.0, 'unit': 'person in a scenario where the Planetary Boundary for Climate Change is not exceded'}, 'relative_PB_ADP': {'value': 25.0, 'unit': 'person in a scenario where the Planetary Boundary for Abiotic Ressources Deplition is not exceded'}}
: Direct energy consumption: 195000.0 kWh, translates to a cost of 23400.000000 $
