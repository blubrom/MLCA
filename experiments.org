...
data$process <- factor(data$process, levels = unique(data$process))
 data %>%
  ...
  labs(x = "Component",
       y  = "GWP (kgCO_2 e)",
       title = paste("Component-wise comparison of the carbon footprint of manufacture of  the", name, "server")) +
...
to_org_table(multi_index_to_multiline_header(table))
    ...
    |                 |      (kWh) |       (kWh) |    (gCO2e) |     (gCO2e) |
    |-----------------+------------+-------------+------------+-------------|
    | spectro 3 steps |      4.473 |      nan    |        228 |         517 |
...
|------------------+------------+----------------+---------------+------------+--------------+-------------+------------+--------------+----------------|
| Transformer_base |         27 |           38.1 |     74.8      |      11.79 |         16.5 |        27.7 |         26 |        36.38 |   61.07        |
| Transformer_big  |        201 |          267   |    523        |      87.09 |        116   |       194   |        192 |       255.74 |  427.7         |
| BERT_base        |       1507 |         2000   |   3920        |     652.17 |        865   |      1450   |       1438 |      1907    | 3196.71        |
...
impact_dict_boavizta = get_impact_dict_b(output)
  ...
  #+RESULTS:
  : {'impacts': {'gwp': {'manufacture': 2400.0, 'use': 2100.0, 'unit': 'kgCO2eq'}, 'pe': {'manufacture': 31000.0, 'use': 71020.0, 'unit': 'MJ'}, 'adp': {'manufacture': 0.19, 'use': 0.000354, 'unit': 'kgSbeq'}}, 'verbose': {'ASSEMBLY-1': {'units': 1, 'manufacture_impacts': {'gwp': {'value': 6.68, 'unit': 'kgCO2eq'}, 'pe': {'value': 68.6, 'unit': 'MJ'}, 'adp': {'value': 1.41e-06, 'unit': 'kgSbeq'}}}, 'CPU-1': {'units': 2, 'manufacture_impacts': {'gwp': {'value': 21.7, 'unit': 'kgCO2eq'}, 'pe': {'value': 325.0, 'unit': 'MJ'}, 'adp': {'value': 0.02, 'unit': 'kgSbeq'}}, 'core_units': {'value': 24, 'unit': 'none', 'status': 'DEFAULT', 'source': None}, 'die_size_per_core': {'value': 0.245, 'unit': 'mm2', 'status': 'DEFAULT', 'source': None}, 'USAGE': {'usage_impacts': {'gwp': {'value': 610.0, 'unit': 'kgCO2eq'}, 'pe': {'value': 20550.0, 'unit': 'MJ'}, 'adp': {'value': 0.000102, 'unit': 'kgSbeq'}}, 'hours_electrical_consumption': {'value': 182.2302330318905, 'unit': 'W', 'status': 'COMPLETED', 'source': None}, 'time_workload': {'value': 50.0, 'unit': '%', 'status': 'DEFAULT', 'source': None}, 'usage_location': {'value': 'EEE', 'unit': 'CodSP3 - NCS Country Codes - NATO', 'status': 'DEFAULT', 'source': None}, 'adp_factor': {'value': 6.42e-08, 'unit': 'KgSbeq/kWh', 'status': 'COMPLETED', 'source': 'ADEME BASE IMPACT'}, 'gwp_factor': {'value': 0.38, 'unit': 'kgCO2e/kWh', 'status': 'COMPLETED', 'source': 'https://www.sciencedirect.com/science/article/pii/S0306261921012149 : \nAverage of 27 european countries'}, 'pe_factor': {'value': 12.874, 'unit': 'MJ/kWh', 'status': 'COMPLETED', 'source': 'ADPf / (1-%renewable_energy)'}, 'use_time': {'value': 8760, 'unit': 'hours', 'status': 'DEFAULT', 'source': None}, 'params': {'value': {'a': 171.2, 'b': 0.0354, 'c': 36.89, 'd': -10.13}, 'unit': 'none', 'status': 'DEFAULT', 'source': None}}}, 'RAM-1': {'units': 12, 'manufacture_impacts': {'gwp': {'value': 45.0, 'unit': 'kgCO2eq'}, 'pe': {'value': 560.0, 'unit': 'MJ'}, 'adp': {'value': 0.0028, 'unit': 'kgSbeq'}}, 'capacity': {'value': 32, 'unit': 'GB', 'status': 'INPUT', 'source': None}, 'density': {'value': 1.79, 'unit': 'GB/cm2', 'status': 'INPUT', 'source': None}, 'USAGE': {'usage_impacts': {'gwp': {'value': 30.0, 'unit': 'kgCO2eq'}, 'pe': {'value': 1025.0, 'unit': 'MJ'}, 'adp': {'value': 5.11e-06, 'unit': 'kgSbeq'}}, 'hours_electrical_consumption': {'value': 9.088, 'unit': 'W', 'status': 'COMPLETED', 'source': None}, 'time_workload': {'value': 50.0, 'unit': '%', 'status': 'DEFAULT', 'source': None}, 'usage_location': {'value': 'EEE', 'unit': 'CodSP3 - NCS Country Codes - NATO', 'status': 'DEFAULT', 'source': None}, 'adp_factor': {'value': 6.42e-08, 'unit': 'KgSbeq/kWh', 'status': 'COMPLETED', 'source': 'ADEME BASE IMPACT'}, 'gwp_factor': {'value': 0.38, 'unit': 'kgCO2e/kWh', 'status': 'COMPLETED', 'source': 'https://www.sciencedirect.com/science/article/pii/S0306261921012149 : \nAverage of 27 european countries'}, 'pe_factor': {'value': 12.874, 'unit': 'MJ/kWh', 'status': 'COMPLETED', 'source': 'ADPf / (1-%renewable_energy)'}, 'use_time': {'value': 8760, 'unit': 'hours', 'status': 'DEFAULT', 'source': None}, 'params': {'value': {'a': 9.088}, 'unit': 'none', 'status': 'COMPLETED', 'source': '(ram_electrical_factor_per_go : 0.284) * (ram_capacity: 32) '}}}, 'SSD-1': {'units': 1, 'manufacture_impacts': {'gwp': {'value': 24.0, 'unit': 'kgCO2eq'}, 'pe': {'value': 293.0, 'unit': 'MJ'}, 'adp': {'value': 0.0011, 'unit': 'kgSbeq'}}, 'capacity': {'value': 400, 'unit': 'GB', 'status': 'INPUT', 'source': None}, 'density': {'value': 50.6, 'unit': 'GB/cm2', 'status': 'INPUT', 'source': None}}, 'SSD-2': {'units': 8, 'manufacture_impacts': {'gwp': {'value': 180.0, 'unit': 'kgCO2eq'}, 'pe': {'value': 2240.0, 'unit': 'MJ'}, 'adp': {'value': 0.0056, 'unit': 'kgSbeq'}}, 'capacity': {'value': 3840, 'unit': 'GB', 'status': 'INPUT', 'source': None}, 'density': {'value': 48.5, 'unit': 'GB/cm2', 'status': 'DEFAULT', 'source': None}}, 'POWER_SUPPLY-1': {'units': 2, 'manufacture_impacts': {'gwp': {'value': 72.7, 'unit': 'kgCO2eq'}, 'pe': {'value': 1050.0, 'unit': 'MJ'}, 'adp': {'value': 0.025, 'unit': 'kgSbeq'}}, 'unit_weight': {'value': 2.99, 'unit': 'kg', 'status': 'DEFAULT', 'source': None}}, 'CASE-1': {'units': 1, 'manufacture_impacts': {'gwp': {'value': 150.0, 'unit': 'kgCO2eq'}, 'pe': {'value': 2200.0, 'unit': 'MJ'}, 'adp': {'value': 0.0202, 'unit': 'kgSbeq'}}, 'case_type': {'value': 'rack', 'unit': 'none', 'status': 'INPUT', 'source': None}}, 'MOTHERBOARD-1': {'units': 1, 'manufacture_impacts': {'gwp': {'value': 66.1, 'unit': 'kgCO2eq'}, 'pe': {'value': 836.0, 'unit': 'MJ'}, 'adp': {'value': 0.00369, 'unit': 'kgSbeq'}}}, 'USAGE': {'usage_impacts': {'gwp': {'value': 2100.0, 'unit': 'kgCO2eq'}, 'pe': {'value': 71020.0, 'unit': 'MJ'}, 'adp': {'value': 0.000354, 'unit': 'kgSbeq'}}, 'hours_electrical_consumption': {'value': 629.7762799999999, 'unit': 'W', 'status': 'COMPLETED', 'source': None}, 'usage_location': {'value': 'EEE', 'unit': 'CodSP3 - NCS Country Codes - NATO', 'status': 'DEFAULT', 'source': None}, 'adp_factor': {'value': 6.42e-08, 'unit': 'KgSbeq/kWh', 'status': 'COMPLETED', 'source': 'ADEME BASE IMPACT'}, 'gwp_factor': {'value': 0.38, 'unit': 'kgCO2e/kWh', 'status': 'COMPLETED', 'source': 'https://www.sciencedirect.com/science/article/pii/S0306261921012149 : \nAverage of 27 european countries'}, 'pe_factor': {'value': 12.874, 'unit': 'MJ/kWh', 'status': 'COMPLETED', 'source': 'ADPf / (1-%renewable_energy)'}, 'use_time': {'value': 8760, 'unit': 'hours', 'status': 'DEFAULT', 'source': None}, 'other_consumption_ratio': {'value': 0.33, 'unit': 'ratio /1', 'status': 'DEFAULT', 'source': None}}}}
  : RAM gwp: 540.0 kgCO2eq
  : SSD gwp: 24.0 kgCO2eq
  : Other component GWP impacts: 302 kgCO2eq
